...
```{r analyze_cds_length, fig.height=6, fig.width=7}
...
```{r plot_cds_length_boxplot, fig.height=7, fig.width=7}
# Create a box-plot
...
```{r nucleotide_frequency_plot, fig.height=4, fig.width=8}
...
```{r amino_acid_frequency_plot, fig.height=6, fig.width=10}
...
```{r codon_usage_heatmap, fig.height=4, fig.width=10}
...
```{r codon_usage_barplot, fig.height=8, fig.width=10}
...
```{r define_kmer_functions, fig.height=5, fig.width=8}
...
```{r compute_kmer_frequencies, fig.height=5, fig.width=8}
...
```{r plot_ecoli_kmer3, compute_kmer_frequencies, fig.height=5, fig.width=8}
...
```{r plot_cbovis_kmer3, fig.height=5, fig.width=8}
...
```{r plot_ecoli_kmer4, fig.height=5, fig.width=8}
...
```{r plot_cbovis_kmer4, fig.height=5, fig.width=8}
...
```{r plot_ecoli_kmer5, fig.height=5, fig.width=8}
...
```{r plot_cbovis_kmer5, fig.height=5, fig.width=8}
